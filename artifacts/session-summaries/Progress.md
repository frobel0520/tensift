...
- The second batch adds color, plant-part, grain, writing-system, material-source, wheel-count, and character-type rules; these need the same second-solution review before their release dates.
